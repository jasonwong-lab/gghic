...
| **Chunked** `calculateResolutionDepthChunked()` | O(unique bins) | Fast | Files > 50% RAM, automated pipelines |
...
Let `findOptimalResolutionChunked()` return the cache for subsequent use:
...
| **Return Cache** | When starting with `findOptimalResolutionChunked()` | 1 operation |
