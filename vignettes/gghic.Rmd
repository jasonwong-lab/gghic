...
cf_100 <- HiCExperiment::CoolFile(
  glue::glue("{dir_cache_gghic}/chr4_11-100kb.cool")
)
hic_100 <- HiCExperiment::import(cf_100)

cf_5 <- HiCExperiment::CoolFile(
  glue::glue("{dir_cache_gghic}/chr4_11-5kb.cool")
)
hic_5 <- HiCExperiment::import(cf_5)

path_gtf <- glue::glue("{dir_cache_gghic}/gencode-chr4_11.gtf.gz")

paths_track <- glue::glue(
  "{dir_cache_gghic}/{c('track1.bigWig', 'track2.bigWig')}"
)
```
