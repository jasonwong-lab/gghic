...
#'   left_join mutate row_number select slice slice_max slice_min summarise
#'   ungroup
#' @importFrom GenomicFeatures genes
#' @importFrom GenomicRanges findOverlaps gaps GRanges GRangesList pintersect
#'   reduce split
#' @importFrom ggplot2 aes coord_fixed draw_key_blank draw_key_polygon
#'   element_blank element_line Geom ggplot ggproto layer scale_fill_gradientn
#'   scale_x_continuous Stat theme theme_bw %+replace%
#' @importFrom ggrastr rasterise
#' @importFrom glue glue
#' @importFrom grDevices colorRampPalette
#' @importFrom grid arrow gList gpar nullGrob polygonGrob polylineGrob
#'   segmentsGrob textGrob unit
